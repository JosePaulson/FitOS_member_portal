    ...
    <div className="px-5 py-6 flex flex-col gap-6">
      ...
      <div className="card p-5 flex items-center gap-4">
        ...
        <div className="min-w-0">
          <p className="font-bold text-lg truncate" style={{ color: S.primary }}>{member?.name}</p>
      ...
      {gym && (
        <div className="flex items-center gap-3 px-1">
          ...
          <div>
            <p className="font-semibold text-sm" style={{ color: S.primary }}>{gym.name}</p>
      ...
      {!installed && (canInstall || isIOS) && (
        <button
          ...
          className="card p-5 flex items-center justify-between text-left"
        >
          <div>
      ...
      <div className="card p-5">
        ...
        <div className="flex items-center justify-between mb-3">
          <button onClick={prevMonth} className="text-lg px-1 transition-colors"
      ...
      <div className="card p-5">
        ...
        {showPin && (
          <form onSubmit={handleChangePin} className="flex flex-col gap-3 mt-4 pt-4"
      ...
      <div className="card p-5 flex flex-col gap-2">
        <h2 className="text-sm font-bold mb-1" style={{ color: S.primary }}>About</h2>
        {[
      ...
      <button onClick={handleLogout} disabled={logoutBusy}
        className="w-full font-semibold py-3 rounded-xl text-sm transition-all disabled:opacity-50"
